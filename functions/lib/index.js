...
exports.rewardDart = exports.initializeUser = exports.recoverStuckTransactions = exports.resetTestnetDailyGold = exports.processPendingTransactions = exports.buyAirtime = exports.requestWithdraw = exports.confirmDepositWebhook = exports.initiateDeposit = exports.sendMoney = void 0;
 ...
 */
exports.initializeUser = (0, simsec_1.withSimSec)({ actionName: 'initializeUser', requireAuth: true }, async (data, context) => {
    const userId = context.auth.uid;
    const { email } = data;
    const userRef = db.collection('users').doc(userId);
 ...
 */
exports.rewardDart = (0, simsec_1.withSimSec)({ actionName: 'rewardDart', requireAuth: true }, async (data, context) => {
    const userId = context.auth.uid;
    const { amount } = data;
